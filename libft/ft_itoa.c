...
/*   Updated: 2025/04/17 17:53:57 by mlucena-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_length(long n)
{
	...
	if (n == 0) //serve pra garantir que o zero conte como 1 dígito
		n++;
	while (n != 0)
	{
		n = n/10;  //Divide 10 até ser zero, e conta quantos dígitos tem
		len++;
	}
	return (len);
}
